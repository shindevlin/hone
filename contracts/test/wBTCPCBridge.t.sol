...
contract BridgeTest is Test {
    ...
    bytes32 constant BIND_TH     = keccak256("Bind(string btcpcUsername,address evmAddress)");
    ...
    function setUp() public {
        ...
        bridge = new wBTCPCBridge(address(token), signers, DAILY_CAP, DAILY_CAP);
