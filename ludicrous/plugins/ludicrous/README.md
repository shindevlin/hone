...
Official [Ludicrous Terminal](https://github.com/shindevlin/ludicrous-plugin) integration for [Claude Code](https://docs.anthropic.com/en/docs/claude-code).
...
- [Ludicrous Terminal](https://github.com/shindevlin/ludicrous-plugin) (macOS, Linux, or Windows)
