...
pub fn show(ui: &mut egui::Ui, data: &mut AppData) {
    ...
    card(ui, |ui| {
        egui::Grid::new("bridge_grid")
            ...
            .show(ui, |ui| {
                ...
                ui.label(egui::RichText::new("wBTCPC contract").color(DIM_TEXT).small());
    ...
    ui.add_space(4.0);
    ui.label(egui::RichText::new(
        "Enter an Ethereum JSON-RPC URL and the deployed wBTCPC ERC-20 contract address to display your wBTCPC balance."
