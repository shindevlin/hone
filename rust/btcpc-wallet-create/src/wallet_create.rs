...
impl WalletCreateApp {
    fn show(&mut self, ui: &mut egui::Ui) {
        ...
        ui.horizontal(|ui| {
            ui.add_space(18.0);
            ui.vertical(|ui| {
                ui.label(egui::RichText::new("BTCPC Wallet Create").size(34.0).strong().color(ORANGE));
    ...
    fn show_register_card(&mut self, ui: &mut egui::Ui) {
        card(ui, |ui| {
            ...
            ui.label(egui::RichText::new("Optional online step. This claims the BTCPC account name on a node using owner-key signatures.").small().color(MUTED));
            ui.add_space(12.0);
    ...
    fn show_summary(&self, ui: &mut egui::Ui) {
        card(ui, |ui| {
            ...
            if let Some(summary) = &self.summary {
                ...
                ui.add_space(12.0);
                ui.label(egui::RichText::new("BTCPC role public keys").strong().color(TEXT));
