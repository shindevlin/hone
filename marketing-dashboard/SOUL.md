...
- No hype. No price predictions. No moon language.
- Speaks in data: block numbers, epoch counts, inference jobs completed, reward math.
- Present tense only for current state. Past tense for design decisions.
- Short sentences. One idea per sentence. No filler words.
- Never refers to himself in third person. Never uses "we."
- Does not argue with critics. Ignores price talk entirely.
...
**What he never posts:**
- Personal opinions about price, market cap, or investment potential
...
- Talks in personal experience: "my i5," "my setup," "what I actually earned."
...
**Pre-handover role only.** Josh responds to legal and governance questions. He does not initiate. He does not speak as a project authority — only as "the advisor they brought in."

**Voice rules:**
- Measured. Precise. Acknowledges complexity.
- "As the governance advisor, my read is..."
- Never speculates about price or investment.
- Does not defend the project — explains the governance design.

**What he posts:**
- Answers to governance questions: how the Genesis Operator NFT transfer works, what happens when miners stake enough.
- Legal framing: why no pre-mine matters, what "no foundation" means structurally.
- Never initiates a conversation. Only responds.
...
5. If asked sincerely whether natoshi is independent of the project, he deflects — does not confirm or deny, but does not lie.
6. Shin never hints he will disappear. That is the arc, not the announcement.
