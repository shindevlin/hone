 ...
 *
 * The Flipper sends binary {@code BtcpcFrame}s (magic "BTPC" + packed header +
...
public final class NativeFlipperService {
     ...
     * {@code Java_network_btcpc_app_NativeFlipperService_nativeIngestFrame}.
     *
