...
public class StakeActivity extends AppCompatActivity {
    ...
    private void showStakeDialog(String roleId, String roleTitle, double minRequired) {
        ...
        if (minRequired > 0) {
            amountField.setHint("Amount (min " + formatAmount(minRequired) + " HONE)");
            amountField.setText(formatAmount(minRequired));
        } else {
            amountField.setHint("Amount (HONE) — optional during bootstrap");
        }
        ...
        AlertDialog dialog = new AlertDialog.Builder(this)
                ...
                .setMessage("Lock HONE as collateral to run a " + roleTitle + " node.")
                .setView(layout)
        ...
        dialog.setOnShowListener(d -> {
            dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(v -> {
                ...
                if (minRequired > 0 && amount < minRequired) {
                    Toast.makeText(this,
                            "Minimum stake is " + formatAmount(minRequired) + " HONE",
                ...
                ChainApi.stake(roleId, finalAmount, prefs.getJwt(), prefs.getEffectiveApiUrl(),
                    ...
                    @Override public void onSuccess(double newAmount, String role) {
                        dialog.dismiss();
                        Toast.makeText(StakeActivity.this,
                                "Staked" + (newAmount > 0 ? " " + formatAmount(newAmount) + " HONE" : "") + " as " + roleTitle,
    ...
    private void showSponsorDialog() {
        ...
        AlertDialog dialog = new AlertDialog.Builder(this)
                ...
                .setMessage("Your HONE covers another user's staking requirement. You earn a share of their node rewards.")
                .setView(layout)
            ...
            dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(v -> {
                ...
                ChainApi.sponsorStake(beneficiary, amount, sharePct,
                    ...
                    @Override public void onSuccess(String ben, double amt, double pct) {
                        dialog.dismiss();
                        Toast.makeText(StakeActivity.this,
                                "Sponsored " + formatAmount(amt) + " HONE for " + ben
