 ...
 * HONE native components.  The same file name ("hone_native_state") is
 * used by the background services so every component reads from a single
 * source of truth.
 */
public class AppPrefs {

    public static final String PREFS_NAME = "hone_native_state";
    ...
    // ---- defaults ----
    public static final String DEFAULT_API_URL      = "https://hone.net";
    public static final String DEFAULT_TESTNET_API_URL = "https://testnet.hone.net";
    public static final String DEFAULT_RELAY_URL   = "wss://hone-relay.shindevlin.workers.dev/ws";
    ...
    public String getChainId() {
        return prefs.getString("chainId", "hone-1");
    }
