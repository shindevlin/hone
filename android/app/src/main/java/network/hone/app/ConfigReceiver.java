 ...
 *
 * Usage:
 *   adb shell am broadcast -a network.hone.app.CONFIGURE \
 *       --es account josh \
 *       --es postingKey <64-char-hex> \
 *       --es chainId hone-satoshi \
 *       --es bootstrapPeers "/dns4/p2p.hone.net/tcp/443/wss/p2p/..."
 *
...
public class ConfigReceiver extends BroadcastReceiver {
    ...
    public  static final String ACTION = "network.hone.app.CONFIGURE";
