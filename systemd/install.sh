...
for service in btcpc-miner btcpc-clock btcpc-explorer btcpcscan-tunnel; do
...
systemctl --user enable btcpc-clock btcpc-miner btcpc-explorer btcpcscan-tunnel

echo ""
echo "[btcpc] Services installed. Commands:"
echo "  systemctl --user start btcpc-clock btcpc-miner btcpc-explorer btcpcscan-tunnel"
