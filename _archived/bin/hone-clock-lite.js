...
var HEARTBEAT_URL = process.env.HONE_HEARTBEAT_URL || "https://hone.net/public/clock-heartbeat";
...
// ── Auto-updater ──
// Check hone.net every hour for a newer clock-lite.js. If the SHA256 differs,
// download it to disk and exit (runit/systemd will restart the service).
var UPDATE_URL = process.env.HONE_UPDATE_URL || "https://hone.net/clock-lite.js";
