...
/**
 * btcpc-clock-standalone — Single-file clock node
 * No repo clone needed. Just: node btcpc-clock-standalone.js
 *
...
var RELAY = process.env.BTCPC_RELAY_URL || "wss://btcpc-relay.shindevlin.workers.dev/ws";
...
console.log("");
console.log("  btcpc-clock — " + ACCOUNT);
...
function handle(msg, from) {
  ...
  switch (msg.type) {
    ...
    case "EPOCH_FINALIZED":
      ...
      console.log("[CLOCK] Block " + ep + " | " + rw + " BTCPC | " + mn + " miner(s)");
