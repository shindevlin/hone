...
```
HONE_GNSS_HOST=192.168.68.75
HONE_GNSS_DEVICE_IP=192.168.68.75
HONE_GNSS_GATEWAY_IP=192.168.68.1
HONE_GNSS_WIFI_IFACE=enp0s31f6
HONE_GNSS_MINER_KEY=<in env>
HONE_ONOCOY_USER=<in env>
HONE_ONOCOY_PASS=<in env>
HONE_RTK_USER=<in env>
HONE_RTK_PASS=<in env>
HONE_RTK_MOUNT=<in env>
```
