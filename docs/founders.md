...
BTCPC began as a weekend experiment: what if a miner ran an AI model instead of SHA-256? The first genesis block was mined on April 2, 2026, from a single GPU node in Shin's home office. The whitepaper was inscribed on block 0 — the chain's first dream, computed into existence.
...
| April 9, 2026 | wBTCPC deployed on 6 chains — Base, Arbitrum, Optimism, Ethereum, Solana, Hive |
...
| TBD | 10+ miners, 1000+ BTCPC staked — chain governs itself |
