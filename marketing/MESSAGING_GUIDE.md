...
- Reference Bitcoin respectfully — we're building on the idea, not replacing it
- Be specific with numbers and facts
- Acknowledge what's still being built (we're in genesis phase)

### Don't
- Use jargon without explaining it
- Hype or make unverifiable claims
- Promise financial returns
- Bash other projects by name
- Pretend we're bigger than we are (yet)

## Tagline Options

**Primary:**
> Bitcoin, but the work matters.

**Alternatives:**
> Mine AI. Earn everywhere.
> The blockchain that dreams.
> Proof of useful work.
> Every token, a dream computed into reality.
...
### 5. Investors / VCs
**Who:** Crypto funds, AI funds, infrastructure investors
**Message:** First-mover at the intersection of $2T crypto and $150B AI compute. Revenue model from day one (users pay for inference). Network effects compound. Working product, live chain.
**Channels:** Direct outreach, crypto conferences, investor decks
...
- **Bitcoin orange** as the accent color (we're building on Bitcoin's legacy)
- **Dark theme** UI (tech-forward, serious, modern)
- **Monospace typography** (code-native, engineering-first)
- **Mining metaphors** — pickaxes, but also neurons, dreams, computation
- **The number 42** should appear subtly throughout (port 4242, 42M supply, etc.)
