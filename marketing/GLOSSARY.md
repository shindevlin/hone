# Glossary — Crypto & AI Terms for Non-Technical People
...
**Mnemonic** — A 12-word phrase that recovers your entire account. Like a master password for all your crypto. Lose it = lose everything. No company can reset it.

**Staking** — Locking up tokens as a security deposit. Miners stake tokens to prove they'll behave honestly. If they cheat, they lose their stake.

**Slashing** — The penalty for cheating. A portion of a miner's staked tokens is taken away if they submit fraudulent work.

**Consensus** — The process by which the network agrees on what's true. Instead of one authority deciding, multiple computers independently verify and agree.

**Genesis Block** — The very first block in a blockchain. Block 0. The beginning of everything.
...
**GPU** — Graphics Processing Unit. Originally designed for video games, now essential for running AI models. The more powerful the GPU, the faster the AI runs.

**Tokens (AI)** — In AI context, a "token" is a chunk of text (roughly a word or part of a word). When we say "1024 tokens generated," it means the AI produced about 750 words.

**Prompt** — The input you give to an AI model. "What is the weather?" is a prompt.
